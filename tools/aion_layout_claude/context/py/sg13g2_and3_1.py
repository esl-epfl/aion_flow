...
#  Created:                   2026-08-25
#  Description:               Auto-generated from GDS: sg13g2_and3_1
# ================================================================

"""Generated AION cell for sg13g2_and3_1."""
...
def generate(name: str, tech: Tech) -> Cell:
    ...
    # Activ
    cell.add_shape(PolygonShape(tech['Activ'], [Point(2280.0, 2170.0), Point(2280.0, 2355.0), Point(380.0, 2355.0), Point(380.0, 3195.0), Point(1940.0, 3195.0), Point(1940.0, 3290.0), Point(3060.0, 3290.0), Point(3060.0, 2170.0)]))
    cell.add_shape(PolygonShape(tech['Activ'], [Point(1940.0, 700.0), Point(1940.0, 800.0), Point(380.0, 800.0), Point(380.0, 1440.0), Point(2720.0, 1440.0), Point(2720.0, 700.0)]))
    ...
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2320.0, 2625.0, 2480.0, 2785.0)))
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2320.0, 2965.0, 2480.0, 3125.0)))
    ...
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(1815.0, 1755.0, 1975.0, 1915.0)))
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2400.0, 1655.0, 2560.0, 1815.0)))
    ...
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2830.0, 2965.0, 2990.0, 3125.0)))
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2830.0, 2625.0, 2990.0, 2785.0)))
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2830.0, 2285.0, 2990.0, 2445.0)))
    ...
    # GatPoly
    cell.add_shape(PolygonShape(tech['GatPoly'], [Point(365.0, 430.0), Point(365.0, 730.0), Point(720.0, 730.0), Point(720.0, 3375.0), Point(850.0, 3375.0), Point(850.0, 730.0), Point(1005.0, 730.0), Point(1005.0, 430.0)]))
    ...
    cell.add_shape(PolygonShape(tech['GatPoly'], [Point(1740.0, 545.0), Point(1740.0, 3375.0), Point(1870.0, 3375.0), Point(1870.0, 2000.0), Point(2060.0, 2000.0), Point(2060.0, 1670.0), Point(1870.0, 1670.0), Point(1870.0, 545.0)]))
    cell.add_shape(PolygonShape(tech['GatPoly'], [Point(2250.0, 520.0), Point(2250.0, 1900.0), Point(2590.0, 1900.0), Point(2590.0, 3505.0), Point(2720.0, 3505.0), Point(2720.0, 1570.0), Point(2380.0, 1570.0), Point(2380.0, 520.0)]))

    # Metal1
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(2440.0, 1125.0, 3065.0, 1385.0)))
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(1765.0, 1400.0, 2060.0, 1950.0)))
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(1090.0, 1400.0, 1560.0, 1980.0)))
    ...
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(400.0, 1090.0), Point(400.0, 3175.0), Point(660.0, 3175.0), Point(660.0, 2320.0), Point(1420.0, 2320.0), Point(1420.0, 3175.0), Point(1680.0, 3175.0), Point(1680.0, 2320.0), Point(2405.0, 2320.0), Point(2405.0, 1900.0), Point(2645.0, 1900.0), Point(2645.0, 1570.0), Point(2245.0, 1570.0), Point(2245.0, 2160.0), Point(660.0, 2160.0), Point(660.0, 1090.0)]))
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(2440.0, 770.0), Point(2440.0, 1385.0), Point(2895.0, 1385.0), Point(2895.0, 2235.0), Point(2780.0, 2235.0), Point(2780.0, 3175.0), Point(3065.0, 3175.0), Point(3065.0, 1125.0), Point(2700.0, 1125.0), Point(2700.0, 770.0)]))
    ...
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(910.0, 2570.0), Point(910.0, 3560.0), Point(0.0, 3560.0), Point(0.0, 4000.0), Point(3360.0, 4000.0), Point(3360.0, 3560.0), Point(2530.0, 3560.0), Point(2530.0, 2575.0), Point(1930.0, 2575.0), Point(1930.0, 3560.0), Point(1170.0, 3560.0), Point(1170.0, 2570.0)]))
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(0.0, -220.0), Point(0.0, 220.0), Point(1930.0, 220.0), Point(1930.0, 1140.0), Point(2190.0, 1140.0), Point(2190.0, 220.0), Point(3360.0, 220.0), Point(3360.0, -220.0)]))
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(1765.0, 1400.0, 2060.0, 1950.0)))
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(1090.0, 1400.0, 1560.0, 1980.0)))
    cell.add_shape(TextShape(tech['Metal1'], 'X', Point(2750.0, 1260.0), purpose='label'))
    ...
    # Ports
    cell.add_port(Port('X', 'X', tech['Metal1'], Rect.from_lbrt(2750.0, 1260.0, 2750.0, 1260.0)))
...
if __name__ == "__main__":
    ...
    c = generate('sg13g2_and3_1', sg13g2_tech)
    c.write_gds("sg13g2_and3_1.gds")
