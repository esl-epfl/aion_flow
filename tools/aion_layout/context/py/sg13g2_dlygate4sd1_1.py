...
#  Created:                   2026-08-25
#  Description:               Auto-generated from GDS: sg13g2_dlygate4sd1_1
# ================================================================

"""Generated AION cell for sg13g2_dlygate4sd1_1."""
...
def generate(name: str, tech: Tech) -> Cell:
    ...
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(920.0, 660.0, 1080.0, 820.0)))
    ...
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(960.0, 2700.0, 1120.0, 2860.0)))
    ...
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2215.0, 2165.0, 2375.0, 2325.0)))
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2200.0, 1015.0, 2360.0, 1175.0)))
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(1120.0, -80.0, 1280.0, 80.0)))
    cell.add_shape(RectShape(tech['Cont'], Rect.from_lbrt(2205.0, 1605.0, 2365.0, 1765.0)))
    ...
    # GatPoly
    cell.add_shape(PolygonShape(tech['GatPoly'], [Point(2695.0, 730.0), Point(2695.0, 1520.0), Point(2120.0, 1520.0), Point(2120.0, 1850.0), Point(2695.0, 1850.0), Point(2695.0, 3240.0), Point(2825.0, 3240.0), Point(2825.0, 730.0)]))
    cell.add_shape(PolygonShape(tech['GatPoly'], [Point(530.0, 410.0), Point(530.0, 1740.0), Point(560.0, 1740.0), Point(560.0, 3155.0), Point(690.0, 3155.0), Point(690.0, 1740.0), Point(840.0, 1740.0), Point(840.0, 1410.0), Point(660.0, 1410.0), Point(660.0, 410.0)]))
    cell.add_shape(PolygonShape(tech['GatPoly'], [Point(1340.0, 410.0), Point(1340.0, 1350.0), Point(1050.0, 1350.0), Point(1050.0, 2020.0), Point(1340.0, 2020.0), Point(1340.0, 3360.0), Point(1470.0, 3360.0), Point(1470.0, 410.0)]))
    ...
    # Metal1
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(2155.0, 960.0), Point(2155.0, 1360.0), Point(2595.0, 1360.0), Point(2595.0, 1810.0), Point(3045.0, 1810.0), Point(3045.0, 2030.0), Point(2140.0, 2030.0), Point(2140.0, 2395.0), Point(2450.0, 2395.0), Point(2450.0, 2205.0), Point(3235.0, 2205.0), Point(3235.0, 1810.0), Point(3315.0, 1810.0), Point(3315.0, 1550.0), Point(2755.0, 1550.0), Point(2755.0, 1160.0), Point(2395.0, 1160.0), Point(2395.0, 960.0)]))
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(3425.0, 610.0), Point(3425.0, 1370.0), Point(3495.0, 1370.0), Point(3495.0, 2220.0), Point(3430.0, 2220.0), Point(3430.0, 3160.0), Point(3685.0, 3160.0), Point(3685.0, 610.0)]))
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(1520.0, 615.0), Point(1520.0, 870.0), Point(1580.0, 870.0), Point(1580.0, 2615.0), Point(1520.0, 2615.0), Point(1520.0, 2945.0), Point(1825.0, 2945.0), Point(1825.0, 1830.0), Point(2415.0, 1830.0), Point(2415.0, 1570.0), Point(1810.0, 1570.0), Point(1810.0, 615.0)]))
    ...
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(2900.0, 2455.0), Point(2900.0, 3560.0), Point(1170.0, 3560.0), Point(1170.0, 2650.0), Point(910.0, 2650.0), Point(910.0, 3560.0), Point(0.0, 3560.0), Point(0.0, 4000.0), Point(3840.0, 4000.0), Point(3840.0, 3560.0), Point(3160.0, 3560.0), Point(3160.0, 2455.0)]))
    cell.add_shape(PolygonShape(tech['Metal1'], [Point(0.0, -220.0), Point(0.0, 220.0), Point(870.0, 220.0), Point(870.0, 870.0), Point(1130.0, 870.0), Point(1130.0, 220.0), Point(2915.0, 220.0), Point(2915.0, 870.0), Point(3175.0, 870.0), Point(3175.0, 220.0), Point(3840.0, 220.0), Point(3840.0, -220.0)]))
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(240.0, 1425.0, 835.0, 1945.0)))
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(3025.0, 1120.0, 3685.0, 1370.0)))
    cell.add_shape(RectShape(tech['Metal1'], Rect.from_lbrt(3025.0, 1120.0, 3685.0, 1370.0)))
...
if __name__ == "__main__":
    ...
    c = generate('sg13g2_dlygate4sd1_1', sg13g2_tech)
    c.write_gds("sg13g2_dlygate4sd1_1.gds")
